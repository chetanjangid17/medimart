...
const AdminDashboard = () => {
    ...
    return (
        <div>
            ...
            <div className=" bg-[#E2F2F2] py-5 border border-pink-100 rounded-lg">
                    <h1 className=" text-center text-2xl font-bold text-[#091434]">Admin Dashboard</h1>
                </div>
            </div>
                        ...
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-[#E2F2F2] hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-[#091434] fonts1" >{getAllProduct.length}</h2>
                            ...
                            <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-[#E2F2F2] hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl" >
                                    ...
                                    <p className=" text-[#091434]  font-bold" >Total Order</p>
                                </div>
                            </Tab>
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-[#E2F2F2] hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-[#091434] fonts1" >{getAllUser.length}</h2>
